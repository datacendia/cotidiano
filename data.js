...
const DATA = {
  ...
  parenting: {
    ...
    sections: [
      ...
      { id: "sick-kids", title: "Sick Kids — Symptoms", icon: "🤒", phrases: [
        { en: "He has a fever", es: "Tiene fiebre", ph: "tee-EH-neh fee-EH-breh" },
        { en: "Let me take your temperature", es: "Déjame tomarte la temperatura", ph: "DEH-hah-meh toh-MAHR-teh lah tehm-peh-rah-TOO-rah" },
        { en: "His forehead is hot", es: "Tiene la frente caliente", ph: "tee-EH-neh lah FREHN-teh kah-lee-EHN-teh" },
        { en: "He threw up", es: "Vomitó", ph: "voh-mee-TOH", note: "Past tense — happened recently. 'Está vomitando' = is vomiting." },
        { en: "His tummy hurts", es: "Le duele la barriga", ph: "leh DWEH-leh lah bah-RREE-gah", note: "'Barriga' = tummy (kid-friendly). 'Estómago' = formal stomach." },
        { en: "Does it hurt here?", es: "¿Te duele aquí?", ph: "teh DWEH-leh ah-KEE" },
        { en: "He has diarrhea", es: "Tiene diarrea", ph: "tee-EH-neh dee-ah-RREH-ah" },
        { en: "He has a runny nose", es: "Tiene la nariz tapada", ph: "tee-EH-neh lah nah-REES tah-PAH-dah", note: "Literally 'blocked nose' — common Lima usage for cold." },
        { en: "He's coughing a lot", es: "Está tosiendo mucho", ph: "ehs-TAH toh-see-EHN-doh MOO-choh" },
        { en: "His ear hurts", es: "Le duele el oído", ph: "leh DWEH-leh ehl oh-EE-doh", note: "'Oído' = inner ear. 'Oreja' = outer ear." },
        { en: "He has a sore throat", es: "Le duele la garganta", ph: "leh DWEH-leh lah gahr-GAHN-tah" },
        { en: "He won't eat anything", es: "No quiere comer nada", ph: "noh kee-EH-reh koh-MEHR NAH-dah" },
        { en: "He's been crying all day", es: "Ha estado llorando todo el día", ph: "ah ehs-TAH-doh yoh-RAHN-doh TOH-doh ehl DEE-ah" },
        { en: "I think we should go to the doctor", es: "Creo que deberíamos ir al doctor", ph: "KREH-oh keh deh-beh-REE-ah-mohs EER ahl dohk-TOHR" },
        { en: "Should we go to the ER?", es: "¿Vamos a emergencias?", ph: "VAH-mohs ah eh-mehr-HEHN-syahs", note: "'Emergencias' = ER in Peru. Hospital options: Clínica Internacional, Ricardo Palma, San Pablo." },
      ]},

      { id: "pediatrician", title: "At the Pediatrician", icon: "🩺", phrases: [
        { en: "I'd like to schedule an appointment", es: "Quisiera sacar una cita", ph: "kee-SYEH-rah sah-KAHR OO-nah SEE-tah", note: "Polite, formal — for the front desk." },
        { en: "He has a fever since yesterday", es: "Tiene fiebre desde ayer", ph: "tee-EH-neh fee-EH-breh DEHS-deh ah-YEHR" },
        { en: "His temperature is thirty-nine", es: "Tiene treinta y nueve de fiebre", ph: "tee-EH-neh TRAYN-tah ee NWEH-veh deh fee-EH-breh", note: "Celsius. 39°C = high fever, go to ER." },
        { en: "I gave him paracetamol", es: "Le di paracetamol", ph: "leh dee pah-rah-seh-tah-MOHL", note: "Brand names in Peru: Panadol Niños." },
        { en: "Is it serious, doctor?", es: "¿Es grave, doctor?", ph: "ehs GRAH-veh, dohk-TOHR" },
        { en: "How often should I give it?", es: "¿Cada cuánto se lo doy?", ph: "KAH-dah KWAHN-toh seh loh DOY" },
        { en: "Every six hours", es: "Cada seis horas", ph: "KAH-dah SAYS OH-rahs" },
        { en: "How many drops?", es: "¿Cuántas gotas?", ph: "KWAHN-tahs GOH-tahs" },
        { en: "What's the dose?", es: "¿Cuál es la dosis?", ph: "kwahl ehs lah DOH-sees" },
        { en: "Are vaccines up to date?", es: "¿Están al día con las vacunas?", ph: "ehs-TAHN ahl DEE-ah kohn lahs vah-KOO-nahs" },
        { en: "What's the next vaccine?", es: "¿Cuál es la siguiente vacuna?", ph: "kwahl ehs lah see-gee-EHN-teh vah-KOO-nah" },
        { en: "Could you write the prescription?", es: "¿Me podría dar la receta?", ph: "meh poh-DREE-ah dahr lah rreh-SEH-tah" },
        { en: "When should we come back?", es: "¿Cuándo regresamos?", ph: "KWAHN-doh rreh-greh-SAH-mohs" },
        { en: "Thanks, doctor", es: "Gracias, doctor", ph: "GRAH-syahs, dohk-TOHR" },
      ]},

      { id: "school-life", title: "School (Colegio) Daily", icon: "🎒", phrases: [
        { en: "Did you finish your homework?", es: "¿Terminaste la tarea?", ph: "tehr-mee-NAHS-teh lah tah-REH-ah" },
        { en: "Show me your homework", es: "Muéstrame la tarea", ph: "MWEHS-trah-meh lah tah-REH-ah" },
        { en: "Do you have a test tomorrow?", es: "¿Tienes prueba mañana?", ph: "tee-EH-nehs PRWEH-bah mah-NYAH-nah", note: "'Prueba' = test/quiz in Peru. 'Examen' = bigger exam." },
        { en: "Did you study?", es: "¿Estudiaste?", ph: "ehs-too-DYAHS-teh" },
        { en: "What grade did you get?", es: "¿Qué nota sacaste?", ph: "keh NOH-tah sah-KAHS-teh", note: "'Nota' = grade. Peru uses 0-20 scale." },
        { en: "Eighteen out of twenty", es: "Dieciocho sobre veinte", ph: "dee-eh-see-OH-choh SOH-breh VAYN-teh", note: "18/20 is excellent in Peru." },
        { en: "Pack your backpack", es: "Alista la mochila", ph: "ah-LEES-tah lah moh-CHEE-lah" },
        { en: "Do you have your lunch?", es: "¿Tienes tu lonchera?", ph: "tee-EH-nehs too lohn-CHEH-rah", note: "'Lonchera' = packed school lunch (very Peruvian)." },
        { en: "Did you behave at school?", es: "¿Te portaste bien en el cole?", ph: "teh pohr-TAHS-teh bee-EHN ehn ehl KOH-leh" },
        { en: "What did the teacher say?", es: "¿Qué dijo la profesora?", ph: "keh DEE-hoh lah proh-feh-SOH-rah", note: "'Profesora' (f) / 'profesor' (m). 'Miss' or 'Profe' is casual." },
        { en: "I'll talk to your teacher", es: "Voy a hablar con tu profesora", ph: "VOY ah ah-BLAHR kohn too proh-feh-SOH-rah" },
        { en: "He won't be at school today", es: "Hoy no va al colegio", ph: "OY noh vah ahl koh-LEH-hyoh" },
        { en: "He's not feeling well", es: "No se siente bien", ph: "noh seh see-EHN-teh bee-EHN", note: "Standard excuse when calling in sick." },
        { en: "Could you send today's homework?", es: "¿Podría mandar la tarea de hoy?", ph: "poh-DREE-ah mahn-DAHR lah tah-REH-ah deh OY", note: "To the teacher when kid is absent." },
        { en: "Parent meeting on Friday", es: "Reunión de padres el viernes", ph: "rreh-oo-NYOHN deh PAH-drehs ehl vee-EHR-nehs" },
      ]},

      { id: "discipline", title: "Discipline & Limits", icon: "✋", phrases: [
        { en: "That's enough", es: "Ya basta", ph: "yah BAHS-tah", note: "Clear stop signal — calm but firm." },
        { en: "I'm counting to three", es: "Voy a contar hasta tres", ph: "VOY ah kohn-TAHR AHS-tah TREHS" },
        { en: "I said no", es: "Te dije que no", ph: "teh DEE-heh keh NOH", note: "Final answer — no more negotiation." },
        { en: "Look at me when I talk to you", es: "Mírame cuando te hablo", ph: "MEE-rah-meh KWAHN-doh teh AH-bloh" },
        { en: "Apologize to your brother", es: "Pídele disculpas a tu hermano", ph: "PEE-deh-leh dees-KOOL-pahs ah too ehr-MAH-noh" },
        { en: "Go to your room", es: "Vete a tu cuarto", ph: "VEH-teh ah too KWAHR-toh" },
        { en: "Time out — five minutes", es: "Cinco minutos en silencio", ph: "SEEN-koh mee-NOO-tohs ehn see-LEHN-syoh", note: "Lima parents often say 'tiempo fuera' but 'cinco minutos en silencio' is more local." },
        { en: "No screens today", es: "Hoy nada de pantallas", ph: "OY NAH-dah deh pahn-TAH-yahs" },
        { en: "Give me the phone", es: "Dame el celular", ph: "DAH-meh ehl seh-loo-LAHR" },
        { en: "Actions have consequences", es: "Las acciones tienen consecuencias", ph: "lahs ahk-SYOH-nehs tee-EH-nehn kohn-seh-KWEHN-syahs" },
        { en: "I'm disappointed", es: "Me has decepcionado", ph: "meh ahs deh-sehp-syoh-NAH-doh", note: "Heavier than 'estoy molesto.' Use sparingly." },
        { en: "We don't hit", es: "No se pega", ph: "noh seh PEH-gah" },
        { en: "Use a kind voice", es: "Habla con respeto", ph: "AH-blah kohn rrehs-PEH-toh" },
        { en: "I love you, but no", es: "Te amo, pero no", ph: "teh AH-moh, PEH-roh NOH", note: "Boundary with warmth — works wonders with kids." },
      ]},

      { id: "bedtime-routine", title: "Bedtime Routine", icon: "🛁", phrases: [
        { en: "Bath time", es: "Hora del baño", ph: "OH-rah dehl BAH-nyoh" },
        { en: "Get in the tub", es: "Métete a la tina", ph: "MEH-teh-teh ah lah TEE-nah" },
        { en: "The water's ready", es: "El agua ya está", ph: "ehl AH-gwah yah ehs-TAH" },
        { en: "Wash your hair", es: "Lávate el pelo", ph: "LAH-vah-teh ehl PEH-loh" },
        { en: "Close your eyes — shampoo", es: "Cierra los ojos, shampoo", ph: "see-EH-rrah lohs OH-hohs, SHAHM-poo" },
        { en: "Out of the tub", es: "Sal de la tina", ph: "SAHL deh lah TEE-nah" },
        { en: "Put on your pajamas", es: "Ponte el pijama", ph: "POHN-teh ehl pee-HAH-mah" },
        { en: "Brush your teeth", es: "Lávate los dientes", ph: "LAH-vah-teh lohs dee-EHN-tehs" },
        { en: "One story, then sleep", es: "Un cuento y a dormir", ph: "oon KWEHN-toh ee ah dohr-MEER" },
        { en: "Which book tonight?", es: "¿Qué cuento esta noche?", ph: "keh KWEHN-toh EHS-tah NOH-cheh" },
        { en: "Lights out", es: "A apagar la luz", ph: "ah ah-pah-GAHR lah LOOS" },
        { en: "Sweet dreams", es: "Dulces sueños", ph: "DOOL-sehs SWEH-nyohs" },
        { en: "Did you have a nightmare?", es: "¿Tuviste una pesadilla?", ph: "too-VEES-teh OO-nah peh-sah-DEE-yah" },
        { en: "It was just a dream", es: "Solo fue un sueño", ph: "SOH-loh fweh oon SWEH-nyoh" },
      ]},

      { id: "milestones", title: "Milestones & Growing Up", icon: "🌱", phrases: [
        { en: "He took his first steps", es: "Dio sus primeros pasos", ph: "DEE-oh soos pree-MEH-rohs PAH-sohs" },
        { en: "He said his first word", es: "Dijo su primera palabra", ph: "DEE-hoh soo pree-MEH-rah pah-LAH-brah" },
        { en: "He lost a tooth", es: "Se le cayó un diente", ph: "seh leh kah-YOH oon dee-EHN-teh" },
        { en: "Did the tooth fairy come?", es: "¿Vino el ratón?", ph: "VEE-noh ehl rrah-TOHN", note: "In Latin America the tooth-collector is 'El Ratón Pérez,' not a fairy." },
        { en: "You're getting so big", es: "¡Cómo has crecido!", ph: "KOH-moh ahs kreh-SEE-doh" },
        { en: "He's outgrowing his shoes", es: "Ya le quedan chicos los zapatos", ph: "yah leh KEH-dahn CHEE-kohs lohs sah-PAH-tohs" },
        { en: "He's not a baby anymore", es: "Ya no es bebé", ph: "yah noh ehs beh-BEH" },
        { en: "Time flies", es: "Cómo pasa el tiempo", ph: "KOH-moh PAH-sah ehl tee-EHM-poh" },
        { en: "He starts kindergarten this year", es: "Empieza el inicial este año", ph: "ehm-pee-EH-sah ehl ee-nee-SYAHL EHS-teh AH-nyoh", note: "'Inicial' (3-5 yrs) → 'Primaria' (6-11) → 'Secundaria' (12-16) in Peru." },
        { en: "First day of school", es: "Primer día de clases", ph: "pree-MEHR DEE-ah deh KLAH-sehs" },
        { en: "Are you nervous?", es: "¿Estás nervioso?", ph: "ehs-TAHS nehr-vee-OH-soh" },
        { en: "I'm proud of you", es: "Estoy orgulloso de ti", ph: "ehs-TOY ohr-goo-YOH-soh deh TEE" },
        { en: "We need to have the talk", es: "Tenemos que hablar de eso", ph: "teh-NEH-mohs keh ah-BLAHR deh EH-soh", note: "Puberty/sex talk — vague Spanish euphemism, just like English." },
        { en: "Your body is changing", es: "Tu cuerpo está cambiando", ph: "too KWEHR-poh ehs-TAH kahm-bee-AHN-doh" },
        { en: "It's all normal", es: "Todo eso es normal", ph: "TOH-doh EH-soh ehs nohr-MAHL" },
      ]},

      { id: "siblings", title: "Sibling Conflict & Co-Parenting", icon: "🤝", phrases: [
        { en: "Stop fighting", es: "Dejen de pelear", ph: "DEH-hehn deh peh-leh-AHR", note: "'Dejen' = ustedes form, addresses both kids at once." },
        { en: "He hit me!", es: "¡Me pegó!", ph: "meh peh-GOH" },
        { en: "Share with your brother", es: "Comparte con tu hermano", ph: "kohm-PAHR-teh kohn too ehr-MAH-noh" },
        { en: "Take turns", es: "Por turnos", ph: "pohr TOOR-nohs" },
        { en: "Whose turn is it?", es: "¿A quién le toca?", ph: "ah kee-EHN leh TOH-kah" },
        { en: "He started it!", es: "¡Él empezó!", ph: "ehl ehm-peh-SOH" },
        { en: "I don't care who started it", es: "No me importa quién empezó", ph: "noh meh eem-POHR-tah kee-EHN ehm-peh-SOH" },
        { en: "He's your little brother", es: "Es tu hermanito", ph: "ehs too ehr-mah-NEE-toh", note: "'Hermanito' = diminutive, evokes protective love." },
        { en: "Take care of him", es: "Cuídalo", ph: "KWEE-dah-loh" },
        { en: "I'll handle this — go to work", es: "Yo me encargo, anda a trabajar", ph: "yoh meh ehn-KAHR-goh, AHN-dah ah trah-bah-HAHR", note: "To Stephania, splitting the load." },
        { en: "Can you take the older one?", es: "¿Puedes con el mayor?", ph: "PWEH-dehs kohn ehl mah-YOHR" },
        { en: "I'll take the baby", es: "Yo me llevo al bebé", ph: "yoh meh YEH-voh ahl beh-BEH" },
        { en: "We need to be on the same page", es: "Tenemos que estar de acuerdo", ph: "teh-NEH-mohs keh ehs-TAHR deh ah-KWEHR-doh", note: "When disciplining the kids — present a united front." },
        { en: "Don't undermine me in front of them", es: "No me contradigas delante de ellos", ph: "noh meh kohn-trah-DEE-gahs deh-LAHN-teh deh EH-yohs", note: "Heavy phrase — for a private conversation with Stephania." },
      ]},
